    ...
    switch (inputType) {
        ...
        case "datepicker-confirm":
	        ...
	        setTimeout(function () { //Set timeout to allow the script to write the input.html before triggering the datepicker
               ...
               // $(".datepick").datepicker("option", "dateFormat", 'dd-M-yy');
	        },100);
            break;
        case "datepicker-confirm-yymmdd":
            // Makesure jQuery UI is loaded on the page
            if (typeof jQuery.ui == 'undefined') {
                alert("jQuery UI is required for the DatePicker control but it is not loaded on the page!");
                break;
        ...
        case "textarea-confirm":
            ...
            break;
        default: // text input
            input.html = startWrapperHtml + "<input id='ejbeatycelledit' class='" + inputCss + "' onfocusout='$(this).updateEditableCell(this)' value='" + oldValue + "' width='300px'></input>" + endWrapperHtml;
            break;
    }
    return input;
}
